...
import { getCurrentUser, storage, KEYS, formatDate, logout } from '@/lib/storage';
...
export default function AttendancePage() {
  ...
  const handleCheckout = () => {
    if (todayRecord && !todayRecord.logoutTime) {
      ...
      // Don't logout the session, just record checkout
        ...
        <div className="card-nawi flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {!todayRecord.logoutTime && (
              <button onClick={handleCheckout} className="btn-outline text-sm">
